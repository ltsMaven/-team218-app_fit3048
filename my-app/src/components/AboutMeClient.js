        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-20 text-center flex flex-col items-center">
            ...
            <h1 className="text-4xl font-semibold leading-tight text-[#42454c] sm:text-5xl lg:text-6xl">
              Welcome to <span className="italic text-[#926ab9]">Ability to Thrive</span>
            </h1>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 items-start">
            {aboutSections.map((section) => (
              ...
              >
                ...
                <div className={`my-6 ${section.bgColor} p-5 rounded-2xl flex items-start gap-3 border border-white/60 shadow-sm`}>
                  <Quote className={`w-6 h-6 ${section.accentColor} flex-shrink-0 mt-0.5`} />
