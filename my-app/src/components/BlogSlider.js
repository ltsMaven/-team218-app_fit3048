      ...
      >
        {blogs.map((blog, index) => (
          <Link
            ...
            className={`min-w-[18rem] snap-start rounded-[2rem] border border-[#d8dfeb] p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(66,69,76,0.08)] sm:min-w-[22rem] lg:min-w-[24rem] ${
              index % 3 === 1
